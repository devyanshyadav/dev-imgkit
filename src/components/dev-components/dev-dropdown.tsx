    ...
    <DropdownMenu.Root {...props}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          sideOffset={3}
          side={position}
          className={`bg-primary origin-[var(--radix-dropdown-menu-content-transform-origin)] z-50 showDropDown dark:bg-primary rounded-lg border-shade shadow-sm border ${contentProps?.className}`}
        >
